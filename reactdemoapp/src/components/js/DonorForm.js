  ...
  handleSubmit(event) {
    ...
    fetch("/user", {
      ...
      .then((data) => {
        ...
        if (data.status === 201)
          this.setState({ success: true, loadingText: false });
        else this.setState({ success: false, error: true });
      })
      .catch(function () {
        console.log("error");
      });
        ...
        {this.state.success ? (
          ...
          <React.Fragment>
            <div className="heading">
              ...
              <li>All the Donated Masks should made with 100% cotton.</li>
            </div>
            <Alert
              variant="danger"
            ...
            >
              ...
              <p>Can you please reload the page and submit the form again.</p>
            </Alert>
                  ...
                  <Form.Group as={Row} controlId="email">
                    ...
                    <Col md={6}>
                      ...
                      <Form.Text className="text-muted">
                        Please Use your Community Care Account email address.
                      </Form.Text>
                    </Col>
                  </Form.Group>
