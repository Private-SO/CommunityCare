...
import donorDashboard from "./js/DonorDashboard";
import requestorDashboard from "./js/RequestorDashboard";
...
import CovidTest from "./js/CovidTest";
      ...
      <div className="wrapper">
        ...
        <section>
          <Switch>
            ...
            <UnPrivateRoute exact path="/covidtest">
              <CovidTest />
            </UnPrivateRoute>
            <PrivateRoute
              exact
            ...
            <Route
              ...
              roles={["admin"]}
              render={(props) => (
                <CheckAllFeedback {...props}></CheckAllFeedback>
              )}
            ></Route>
            <Route
